module OpenSimplex;
// Taken from https://github.com/KdotJPG/OpenSimplex2/blob/master/_old/cpp/OpenSimplex2S.hpp
...
OpenSimplex2S::OpenSimplex2S(unsigned long seed) {
  short source[PSIZE]{};
...
double OpenSimplex2S::noise2_Base(double xs, double ys) {
  ...
  int index = (a << 2) | static_cast<int>(xsi - ysi / 2 + 1 - a / 2.0) << 3 | static_cast<int>(ysi - xsi / 2 + 1 - a / 2.0) << 4;
